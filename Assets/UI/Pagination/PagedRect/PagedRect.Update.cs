...
namespace UI.Pagination
{
    public partial class PagedRect
    {
        ...
        public void UpdatePages(bool force = false, bool forceRenewPageNumbers = false)
        {
            ...
            var tempPages = Viewport.GetComponentsInChildren<Page>(!UsingScrollRect).Where(p => (UsingScrollRect || p.ShowOnPagination) && p.transform.parent == Viewport.transform).ToList();
