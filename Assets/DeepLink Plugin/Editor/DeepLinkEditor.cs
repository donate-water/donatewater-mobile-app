...
class DeepLinkEditor : EditorWindow
{
    ...
    void Awake()
    {
        ...
        {
            string_host = PlayerSettings.applicationIdentifier;// "com.comp.rails";
    ...
    void AddDeepLinkDataBLock(XmlDocument doc)
    {
        ...
        foreach (XmlNode n in xnl)
        {
            ...
            {
                //get this intent's activity
                n.ParentNode.ParentNode.Attributes["android:name"].Value="causallink.assets.DeepLinkBridge";
                //------------------------
    ...
    void EditManifest()
    {
        ...
        rootNode.Value = PlayerSettings.applicationIdentifier;
    ...
    void CopyManifest()
    {
        ...
        else
        {
            ...
            File.Copy(Application.dataPath + "/DeepLink Plugin/Jar/DeepLink.jar", Application.dataPath + "/Plugins/Android/DeepLink.jar", true);
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.SelectableLabel("2.0", GUILayout.Height(16));
